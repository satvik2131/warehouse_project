...
const usersData = [
    ...
    { id: 1, Purchase_Date: '21/12/2020', Purchase_Order_ID: '651645',Invoice_ID:"44785556", Supplier_Name: 'Karad Supplier', Total_Price: '$150'}
]
                ...
                <CCol lg="12">
                    <CCard>
                        <CCardHeader className="d-flex justify-content-between align-items-center">
                            ...
                            <Link to="/purchase/add-purchase-return">
                                <CButton size="md" color="success" className="ml-auto">+ Add Return</CButton>
                            </Link>
