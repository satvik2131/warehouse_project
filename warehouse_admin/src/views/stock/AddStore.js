        ...
        <CCol xs="12" md="12" >
          <CCard>
            ...
            <CCardBody>
              <CForm action="" method="post" encType="multipart/form-data" className="form-horizontal">
                ...
                <CFormGroup row>                  
                  ...
                  <CCol xs="12" md="6" className="mt-2 mb-2">
                    <CLabel htmlFor="text-input">Store Name*</CLabel>
            ...
            <CCardFooter className="text-right">
              <CButton type="submit" size="" color="success" className="mr-2"><CIcon name="cil-scrubber" /> Add Store</CButton>
