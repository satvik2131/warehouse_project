                ...
                <CCol lg="12">
                    <CCard>
                        <CCardHeader className="d-flex justify-content-between align-items-center">
                            <h4>Add Sale Cancellation </h4>
                            <div>
                            <CButton size="md" color="danger" className="ml-auto mr-2">Cancel All</CButton>                            
                            <Link to="/sales/sale-cancellation">
...
export default AddSalesCancellation;
