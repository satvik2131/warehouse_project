...
const usersData = [
    {id: 0, Date:'12/12/2020',Sale_Order_ID: '1000', Customer_name: 'John Michale', Total_price: '$ 20000.00'},
    {id: 1, Date:'14/12/2020', Sale_Order_ID: '2000', Customer_name: 'Michale', Total_price: '$ 100.00'}
  ]
                                                            ...
                                                            <div className="col-lg-12">
                                                                <table className="table table-sm purchase_order_view">                                                            
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <th scope="row">Sale Order Status </th>
                                                                            <td>: Open</td>                                                                   
                                                                        </tr>                                                                
                                                                    </tbody>
                                                                </table>
