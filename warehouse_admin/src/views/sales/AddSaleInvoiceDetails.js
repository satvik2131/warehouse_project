...
import SaleOrderLastStep from './SaleOrderLastStep';
...
const useStyles = makeStyles((theme) => ({  
  ...
  function getSteps() {
    return ['Invoice Header', 'Invoice Type', 'Sale Order'];
  }
                  ...
                  <CForm action="" method="post" encType="multipart/form-data" className="form-horizontal">                    
                    <CFormGroup row>                  
                      <CCol xs="12" md="4" className="mt-2 mb-2">
                        <CLabel htmlFor="date-input" className="fontnsize">Sale Date*</CLabel>
                        <CInput className="fontnsize"  type="date" id="date-input" name="date-input" placeholder="date" />                                         
                      </CCol>
                      <CCol xs="12" md="4" className="mt-2 mb-2">
                        <CLabel htmlFor="text-input" className="fontnsize">Sale Code*</CLabel>
                      ...
                      <CCol xs="12" md="4" className="mt-2 mb-2">
                       <CLabel htmlFor="select" className="fontnsize">Customer* </CLabel>
          ...
          {activeStep === steps.length ? (
            <div className="text-center">
              {/* <Typography className={classes.instructions}>Thanks for the PO ref:<span>PO_20200226232</span></Typography> */}
                        ...
                        <Link to="/Sale/Sale-invoice">
                          <CButton type="submit" size="" color="secondary" className="mr-2"><CIcon name="cil-print" /> Print</CButton>
                        </Link>
                      
              <Button variant="contained" color="secondary" onClick={handleReset}>New SI</Button>
            </div>
          ) : (
            <div>
  ...
  export default AddSaleInvoiceDetails;