...
const usersData = [
    { id: 0, Sale_Date: '11/12/2020', Invoice_ID: '124778569', Sale_Order_ID: '150051', Customer_Name: 'Rohit ', Total_Price: '$200', Total_Quantity: '50'},
    { id: 1, Sale_Date: '21/12/2020', Invoice_ID: '789654123', Sale_Order_ID: '651645', Customer_Name: 'Karad', Total_Price: '$150', Total_Quantity: '10'}
]

const fields = [
    {
        key: 'Checkbox',
        label: <Checkbox className="p-0" color="primary" />,
        _style: { width: '1%' },        
        filter: false
    },
    { key: 'Sale_Order_ID'},
                ...
                <CCol lg="12">
                    <CCard>
                        <CCardHeader className="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                            <CButton size="md" color="danger" className="ml-auto mr-2">Return All</CButton>                            
                            <Link to="/sales/sales-returns-list">
                                        ...
                                        () => {
                                            return (
                                                <td className="py-2 d-flex">
                                                    <CButton size="sm"  color="success" className="ml-1"  onClick={handleClickOpen}>
                                                    ...
                                                    <Dialog className="purchase_cancel_dialog" onClose={handleClose} aria-labelledby="customized-dialog-title" open={open}>
                                                        ...
                                                        <div className="row">
                                                          ...
                                                          <table className="table table-sm purchase_order_view_all_products">    
                                                                    <thead>
                                                                        ...
                                                                        <tbody> 
                                                                            <tr>
                                                                                <td><Checkbox fontSize="small" className="p-0" color="primary" inputProps={{ 'aria-label': 'checkbox with small size' }}/></td>
                                                                                <td scope="row">Banana</td>                                                                                 
                                                        ...
                                                        <DialogActions>
                                                           <CButton size="sm"  color="danger" className="ml-1" onClick={handleClose}>
                                                            ...
                                                            <RemoveIcon fontSize="small"/> Return Order
                                                            </CButton>
                                                        </DialogActions>                                                       
                                                    </Dialog>
...
export default SalesAddReturns;
